...
class BBDMRunner(DiffusionBaseRunner):
    ...
    def loss_fn(self, net, batch, epoch, step, opt_idx=0, stage='train', write=True):
        ...
        loss, additional_info, feat_3_input_loss, feat_3_output_loss, feat_middle_loss = net(x, x_name, x_cond)
        ...
        return loss, feat_3_input_loss, feat_3_output_loss, feat_middle_loss
