...
class BaseRunner(ABC):
    ...
    def validation_epoch(self, val_loader, epoch):
        ...
        loss_sum = 0.
        dloss_sum = 0.
        loss_feat_3_input_loss=0.
        loss_feat_3_output_loss = 0.
        loss_feat_middle_loss = 0.
        for val_batch in pbar:
            loss, feat_3_input_loss, feat_3_output_loss, feat_middle_loss = self.loss_fn(net=self.net,
                                batch=val_batch,
                                epoch=epoch,
                                step=step,
                                opt_idx=0,
                                ...
                                write=False)
            loss_sum += loss
            loss_feat_3_input_loss += feat_3_input_loss
            loss_feat_3_output_loss += feat_3_output_loss
            loss_feat_middle_loss += feat_middle_loss
        ...
        avg_feat_3_input_loss = loss_feat_3_input_loss / step
        avg_feat_3_output_loss = loss_feat_3_output_loss / step
        avg_feat_middle_loss = loss_feat_middle_loss / step
        if self.is_main_process:
        ...
        self.restore_ema()
        return average_loss, avg_feat_3_input_loss, avg_feat_3_output_loss, avg_feat_middle_loss
            ...
            for epoch in range(start_epoch, self.config.training.n_epochs):
                ...
                if True:
                    ...
                    with torch.no_grad():
                        ...
                        average_loss, avg_feat_3_input_loss, avg_feat_3_output_loss, avg_feat_middle_loss = self.validation_epoch(val_loader, epoch)
                        torch.cuda.empty_cache()
